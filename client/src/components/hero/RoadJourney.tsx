      ...
      {points.map((point, index) => {
        ...
        return (
          ...
          >
            ...
            <span className="hidden whitespace-nowrap rounded-full border border-slate-700 bg-slate-800 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-slate-300 shadow-sm sm:inline-block">{stop.label}</span>
          </div>
        );
      })}
